...
import 'package:locksmith/Screens/KeyPlusKeyProgramming.dart';
...
class KeyProgramming extends StatelessWidget {
  const KeyProgramming({super.key});
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const SimpleKey()));
                },
                child: Container(
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const KeyPlusKeyProgramming()));
                },
                child: Container(
                  alignment: Alignment.center,
                  height: 60,
